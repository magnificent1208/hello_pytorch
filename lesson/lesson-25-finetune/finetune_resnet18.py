...
'''
模型微调 Model Finetune
Transfer Learning ：机器学习的分支，
Transfer Learning ：机器学习的分支，
研究源域(source domain)的知识如何应用于目标域(target domain)
...
模型微调训练方法：
1. 固定预训练的参数(require_grad = False;lr = 0)
2. Feature Extractor 较小学习率 (params_group)
...
# ============================ step 4/5 优化器 ============================
# 法2 : conv 小学习率  推荐使用这种方法调固定卷积层参数(把优化器数据置0）
# flag = 0
flag = 1
if flag:
