...
class RMBDataset(Dataset):
    #关于__init__()与__getitem__()及__len__()三件套  @https://zhuanlan.zhihu.com/p/87786297
    ...
    #根据图片&标签 返回label
    def __getitem__(self, index):  # __getitem__ 可以让对象实现迭代功能，这样就可以使用for...in... 来迭代该对象了 refer：https://zhuanlan.zhihu.com/p/163242930  @
